...
- Замечание про next-hop-self. Использование этого параметра правильнее нежеле redistribute connected внутри iBGP. Он упрощает таблицу маршрутизации убирая из неё внешние линки. Поэтому на узлах R23-R26 убираю redistribute connected на next-hop-self.

- Таблица маршрутизации BGP до:
```
Network          Next Hop            Metric LocPrf Weight Path
* i 10.0.0.0/31      10.0.0.30                0    100      0 101 1001 ?
*>                   10.0.0.28                              0 301 1001 ?
* i 10.0.0.2/31      10.0.0.30                0    100      0 101 1001 ?
*>                   10.0.0.28                              0 301 1001 ?
* i 10.0.0.4/31      10.0.0.30                0    100      0 101 1001 ?
*>                   10.0.0.28                              0 301 1001 ?
* i 10.0.0.6/31      10.0.0.30                0    100      0 101 1001 ?
*>                   10.0.0.28                              0 301 1001 ?
* i 10.0.0.8/31      10.0.0.30                0    100      0 101 ?
*>                   10.0.0.28                              0 301 1001 i
* i 10.0.0.10/31     10.0.0.30                0    100      0 101 1001 ?
*>                   10.0.0.28                              0 301 1001 ?
*>  10.0.0.12/31     10.0.0.28                0             0 301 ?
* i 10.0.0.14/31     10.0.0.30                0    100      0 101 1001 ?
*>                   10.0.0.28                              0 301 1001 ?
* i 10.0.0.16/31     10.0.0.24                0    100      0 2042 ?
*>                   10.0.0.22                0             0 2042 ?
* i 10.0.0.20/31     10.0.0.24                0    100      0 2042 ?
*>                   10.0.0.22                0             0 2042 ?
r i 10.0.0.22/31     10.0.0.24                0    100      0 2042 i
r>                   10.0.0.22                0             0 2042 i
*   10.0.0.24/31     10.0.0.22                0             0 2042 ?
*>i                  10.1.0.26                0    100      0 ?
* i 10.0.0.26/31     10.0.0.30                0    100      0 101 ?
*>                   10.0.0.28                0             0 301 ?
r>  10.0.0.28/31     10.0.0.28                0             0 301 ?
*   10.0.0.30/31     10.0.0.28                              0 301 101 ?
*>i                  10.0.0.30                0    100      0 101 ?
r>i 10.0.0.32/31     10.1.0.25                0    100      0 ?
r>i 10.0.0.36/31     10.1.0.26                0    100      0 ?
*>i 10.0.0.38/31     10.1.0.25                0    100      0 ?
r i 10.0.0.40/31     10.1.0.25                0    100      0 ?
r>i                  10.1.0.26                0    100      0 ?
*>i 10.0.0.42/31     10.1.0.25                0    100      0 ?
r>i 10.0.0.44/31     10.1.0.26                0    100      0 ?
* i 10.0.0.46/31     10.0.0.30                0    100      0 101 1001 ?
*>                   10.0.0.28                              0 301 1001 ?
* i 10.1.0.14/32     10.0.0.30                0    100      0 101 1001 ?
*>                   10.0.0.28                              0 301 1001 ?
* i 10.1.0.15/32     10.0.0.30                0    100      0 101 1001 ?
*>                   10.0.0.28                              0 301 1001 ?
* i 10.1.0.18/32     10.0.0.24                0    100      0 2042 ?
*>                   10.0.0.22                0             0 2042 ?
*>  10.1.0.21/32     10.0.0.28                0             0 301 ?
* i 10.1.0.22/32     10.0.0.30                0    100      0 101 ?
*>                   10.0.0.28                              0 301 101 ?
r>i 10.1.0.25/32     10.1.0.25                0    100      0 ?
r>i 10.1.0.26/32     10.1.0.26                0    100      0 ?
r>i 192.168.102.0    10.0.0.45                0    100      0 i
```
- После:
```
Network          Next Hop            Metric LocPrf Weight Path
*   10.0.0.0/31      10.0.0.28                              0 301 1001 ?
* i                  10.1.0.23                0    100      0 101 1001 ?
*   10.0.0.2/31      10.0.0.28                              0 301 1001 ?
* i                  10.1.0.23                0    100      0 101 1001 ?
*   10.0.0.4/31      10.0.0.28                              0 301 1001 ?
* i                  10.1.0.23                0    100      0 101 1001 ?
*   10.0.0.6/31      10.0.0.28                              0 301 1001 ?
* i                  10.1.0.23                0    100      0 101 1001 ?
*   10.0.0.8/31      10.0.0.28                              0 301 1001 i
* i                  10.1.0.23                0    100      0 101 ?
*   10.0.0.10/31     10.0.0.28                              0 301 1001 ?
* i                  10.1.0.23                0    100      0 101 1001 ?
*   10.0.0.12/31     10.0.0.28                0             0 301 ?
* i                  10.1.0.23                0    100      0 101 301 ?
*   10.0.0.14/31     10.0.0.28                              0 301 1001 ?
* i                  10.1.0.23                0    100      0 101 1001 ?
*   10.0.0.16/31     10.0.0.22                0             0 2042 ?
* i                  10.1.0.26                0    100      0 2042 ?
*   10.0.0.20/31     10.0.0.22                0             0 2042 ?
* i                  10.1.0.26                0    100      0 2042 ?
*   10.0.0.22/31     10.0.0.22                0             0 2042 i
* i                  10.1.0.26                0    100      0 2042 i
*   10.0.0.24/31     10.0.0.22                0             0 2042 ?
* i                  10.1.0.26                0    100      0 2042 ?
*   10.0.0.26/31     10.0.0.28                0             0 301 ?
* i                  10.1.0.23                0    100      0 101 ?
*   10.0.0.28/31     10.0.0.28                0             0 301 ?
* i                  10.1.0.23                0    100      0 101 301 ?
*   10.0.0.30/31     10.0.0.28                              0 301 101 ?
* i                  10.1.0.23                0    100      0 101 ?
*   10.0.0.46/31     10.0.0.28                              0 301 1001 ?
* i                  10.1.0.23                0    100      0 101 1001 ?
*   10.1.0.14/32     10.0.0.28                              0 301 1001 ?
* i                  10.1.0.23                0    100      0 101 1001 ?
*   10.1.0.15/32     10.0.0.28                              0 301 1001 ?
* i                  10.1.0.23                0    100      0 101 1001 ?
*   10.1.0.18/32     10.0.0.22                0             0 2042 ?
* i                  10.1.0.26                0    100      0 2042 ?
*   10.1.0.21/32     10.0.0.28                0             0 301 ?
* i                  10.1.0.23                0    100      0 101 301 ?
*   10.1.0.22/32     10.0.0.28                              0 301 101 ?
* i                  10.1.0.23                0    100      0 101 ?
* i 192.168.102.0    10.1.0.26                0    100      0 i
``` 
